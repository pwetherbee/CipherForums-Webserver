...
},{}],"forum_post/model.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            url = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : "".concat(endpoint, "/api/threads/").concat(state.id);
            _context2.next = 3;
            return fetch(url, {
              method: "POST",
              headers: {
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            url = _args3.length > 1 && _args3[1] !== undefined ? _args3[1] : "".concat(endpoint, "/api/threads");
            _context3.next = 3;
            return fetch(url, {
              method: "PUT",
              headers: {
...
var View = /*#__PURE__*/function () {
  ...
  _createClass(View, [{
    ...
    value: function update(data) {
      ...
      var newDom = document.createRange().createContextualFragment(newMarkup); // create new html element with new markup
      //create new nodes
      ...
      newElements.forEach(function (newElement, i) {
        ...
        var currElement = currElements[i];

        if (!newElement.isEqualNode(currElement) && ((_newElement$firstChil = newElement.firstChild) === null || _newElement$firstChil === void 0 ? void 0 : _newElement$firstChil.nodeValue.trim()) !== "") {
        ...
        if (!newElement.isEqualNode(currElement)) {
          Array.from(newElement.attributes).forEach(function (attribute) {
            currElement === null || currElement === void 0 ? void 0 : currElement.setAttribute(attribute.name, attribute.value);
          });
        }
      });
    }
...
},{}],"forum_post/views/forumView.js":[function(require,module,exports) {
"use strict";
...
var ForumView = /*#__PURE__*/function (_View) {
  _inherits(ForumView, _View);

  var _super = _createSuper(ForumView);
  ...
  function ForumView() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_parentElement", document.querySelector(".thread__container"));

    _defineProperty(_assertThisInitialized(_this), "_container", _this._parentElement.parentElement);

    _defineProperty(_assertThisInitialized(_this), "_errorMessage", "Could not render thread");

    return _this;
  }

  _createClass(ForumView, [{
    ...
    value: function _generateMarkup() {
      ...
      this._data.comments.forEach(function (comment) {
        markup += _this2._commentMarkup(comment, true);
      });
    ...
    value: function _commentMarkup(comment) {
      ...
      return "\n        <div class=\"comment__container\">\n          <h class=\"comment__header\">".concat(comment.author, " on ").concat(date || "unknown", " said: <btn class = \"btn__reply\">[reply]</btn></h>\n          <p class=\"comment__body\">\n              ").concat(init ? "&shy" : comment.text, "\n          </p>\n        </div>\n        ");
    }
  }, {
    key: "pushComment",
    value: function pushComment(comment) {
      var markup = this._commentMarkup(comment);
...
},{"./View.js":"forum_post/views/View.js","moment":"../node_modules/moment/moment.js"}],"forum_post/views/keyView.js":[function(require,module,exports) {
"use strict";
...
var KeyView = /*#__PURE__*/function (_View) {
  _inherits(KeyView, _View);

  var _super = _createSuper(KeyView);
  ...
  function KeyView() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_parentElement", document.querySelector(".key__container"));

    _defineProperty(_assertThisInitialized(_this), "_keyTextbox", _this._parentElement.querySelector(".key__textbox"));

    return _this;
  }

  _createClass(KeyView, [{
    key: "addHandlerInputText",
    value: function addHandlerInputText(handler) {
      this._parentElement.querySelector(".key__textbox").addEventListener("input", handler);
    }
  }, {
    key: "changeKeyValue",
    value: function changeKeyValue(newKey) {
    ...
    key: "addHandlerHideKey",
    value: function addHandlerHideKey(handler) {
...
var _default = new KeyView();

exports.default = _default;
},{"./View":"forum_post/views/View.js"}],"node_modules/core-js/internals/global.js":[function(require,module,exports) {
var global = arguments[3];
...
function dec_to_text(hex, key_dec) {
  ...
  var xOrd = BigInt(hex_to_dec(hex)) ^ BigInt(key_dec);
  var text = hex_to_text(dec_to_hex(xOrd));
...
function text_to_dec(text, key) {
  var paddedText = padText(text);
  var commentXorHex = dec_to_hex(BigInt(hex_to_dec(ascii_to_hexa(paddedText))) ^ BigInt(key_to_dec(key)));
...
var _forumView = _interopRequireDefault(require("./views/forumView.js"));

var _keyView = _interopRequireDefault(require("./views/keyView.js"));

require("core-js/stable");

var _moment = _interopRequireDefault(require("moment"));

var _convert = require("../helpers/convert.js");
...
var controlInitialLoad = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var url, id, data, interval;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = window.location.href;
            id = url.split("/").slice(-1); // Grabs url after /threads/
          ...
          case 16:
            ...
            interval = setInterval(function () {
              _keyView.default.changeKeyValue(Math.floor(Math.pow(10, 8) * Math.random()).toString(16));
            ...
            setTimeout(function () {
              ...
              _keyView.default.changeKeyValue("default_key");
...
var controlForumView = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            id = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : 999;
            _context2.next = 3;
            return model.getForum(id);
  ...
  return function controlForumView() {
    return _ref2.apply(this, arguments);
  };
}();

var controlUpdateKey = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var key, key_dec, encryptedComments, decryptedComments, i;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            // get current key
            key = document.querySelector(".key__textbox").value; // convert key to dec

            key_dec = (0, _convert.key_to_dec)(key); // get all comments

            encryptedComments = model.state.comments.map(function (comment) {
              return comment.text;
            }); // decrypt all comments

            decryptedComments = encryptedComments.map(function (enctext) {
              return (0, _convert.decrypt)(enctext, key_dec);
            });
            commentEls = document.querySelectorAll(".comment__body");
            i = 0;

          case 6:
            if (!(i < commentEls.length)) {
              _context3.next = 13;
              break;
            }

            _context3.next = 9;
            return (0, _convert.sleep)(30);
  ...
  return function controlUpdateKey() {
    return _ref3.apply(this, arguments);
  };
}();

var parseComment = function parseComment(comment) {
  if (!comment) {
    return "...";
  }

  if (comment.startsWith("#img[")) {
    return "<img src = ".concat(comment.split("[")[1].slice(0, -1), ">");
  }

  if (comment.startsWith("#video[")) {
    var embed = comment.split("[")[1].slice(0, -1).replace("watch", "embed");
    console.log(embed);
...
var controlPostComment = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    var commentTextBox, commentText, key, commentEncrypted, currTime, authorTest, comment, unencrypted;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            commentTextBox = document.querySelector(".comment__textbox");
          ...
          case 4:
            key = document.querySelector(".key__textbox").value;
            commentEncrypted = (0, _convert.text_to_dec)(commentText, key);
            currTime = _moment.default.utc();
            authorTest = "Anonymous";
            comment = {
            ...
            _context4.next = 11;
            return model.postComment(comment);
          ...
          case 11:
            ...
            _forumView.default.pushComment(unencrypted);
  ...
  return function controlPostComment() {
...
init();
},{"regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","./model.js":"forum_post/model.js","./views/forumView.js":"forum_post/views/forumView.js","./views/keyView.js":"forum_post/views/keyView.js","core-js/stable":"node_modules/core-js/stable/index.js","moment":"../node_modules/moment/moment.js","../helpers/convert.js":"helpers/convert.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","forum_post/controller.js"], null)
//# sourceMappingURL=/controller.672ac1cb.js.map