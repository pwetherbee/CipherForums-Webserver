...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"keychain/main.js":[function(require,module,exports) {
...
function updateBox() {
  ...
  for (var i = 0; i < myClasses.length; i++) {
    var xOrd = BigInt(hex_to_dec(hexComments[i])) ^ BigInt(keyDec);
...
var interval = setInterval(crazy, 10);
setTimeout(function () {
...
function addComment(comment) {
  ...
  comment_box.value = "";
  var commentPadded = padComment(comment); // This turns the padded comment into hex, then to decimal, then Xor's it with keydec, and then takes that xor output in decimal and turns it back into hex
  ...
  var commentXorHex = dec_to_hex(BigInt(hex_to_dec(ascii_to_hexa(commentPadded))) ^ BigInt(keyXOR(keyInput.value))); // commentXorHex is what should be sent to be stored on database
...
var comment_box = document.querySelector(".commentBox");
var comment_btn = document.querySelector(".btn__comment");
comment_btn.addEventListener("click", function () {
  addComment(comment_box.value);
});
comment_box.addEventListener("keyup", function (e) {
  if (e.key === "Enter") {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","keychain/main.js"], null)
//# sourceMappingURL=/main.38c2f765.js.map