...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"helpers/convert.js":[function(require,module,exports) {
"use strict";
...
var _convert = require("./helpers/convert");
...
function keyXOR(key) {
  return (0, _convert.hex_to_dec)((0, _convert.ascii_to_hexa)((0, _convert.sha256)(key)));
}
...
function updateBox() {
  ...
  for (var i = 0; i < myClasses.length; i++) {
    var xOrd = BigInt((0, _convert.hex_to_dec)(hexComments[i])) ^ BigInt(keyDec);
    var text = (0, _convert.hex_to_text)((0, _convert.dec_to_hex)(xOrd));
...
function crazy() {
  keyInput.value = (0, _convert.dec_to_hex)(600 * Math.random());
  updateBox();
}
...
},{"./helpers/convert":"helpers/convert.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
